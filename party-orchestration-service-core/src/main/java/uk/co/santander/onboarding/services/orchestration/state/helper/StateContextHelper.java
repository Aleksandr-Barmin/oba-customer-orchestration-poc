...
public class StateContextHelper {
    public ApplicantValidationResult getApplicationValidationResult(final StateContext<OrchestrationState, OrchestrationEvent> context) {
        ...
        return ApplicantValidationResult.of(
                read(
                        ...
                        ApplicantValidationStatus.class
                ),
                read(
                        context,
    ...
    public void setApplicantValidationResult(final StateContext<OrchestrationState, OrchestrationEvent> context,
    ...
    private <T> T read(final StateContext<OrchestrationState, OrchestrationEvent> context,
                       final String field,
    ...
    private void write(final StateContext<OrchestrationState, OrchestrationEvent> context,
                       final String field,
                       final Object value) {
