...
@Component
public class OnGetApplicantData implements Action<OrchestrationState, OrchestrationEvent> {
    @Autowired
    ...
    public void execute(StateContext<OrchestrationState, OrchestrationEvent> context) {
        ...
        applicationService.createRecord(applicationId, "Data from party data service received");
    }
}
