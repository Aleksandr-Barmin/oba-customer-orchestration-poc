...
public class ApplicantValidationResult {
    ...
    public static ApplicantValidationResult noApplicant() {
        return ApplicantValidationResult.of(
                ApplicantValidationStatus.NOT_SUCCESS, "Can't retrieve applicant data");
    }

    public static ApplicantValidationResult success() {
        return ApplicantValidationResult.of(ApplicantValidationStatus.SUCCESS, "Success validation");
    }

    public static ApplicantValidationResult unknown() {
        return ApplicantValidationResult.of(ApplicantValidationStatus.UNKNOWN, "Status is unknown");
    }
